...
*/
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
        ...
        //stdDraw.filledRectangle(.5, .85, .2, .04);
        stdDraw.picture(.15, .17, "flower4.png", .3, .4);
        stdDraw.picture(.85, .17, "flower2.png", .3, .4);
        stdDraw.picture(.5, .85, "flower3.jpeg", .7, .35);
        stdDraw.setPenColor(stdDraw.PINK);
        stdDraw.filledCircle(0.5, 0.4, 0.3);
        stdDraw.setPenColor(stdDraw.WHITE);
        stdDraw.setPenRadius(0.03);
        stdDraw.arc(0.5, 0.4, 0.18, 210, -30);
        stdDraw.setPenRadius(0.06);
        stdDraw.point(0.42, 0.47);
        stdDraw.point(0.58, 0.47);
        Font font2 = new Font("Jokerman", Font.BOLD, 38);
        stdDraw.setFont(font2);
        stdDraw.setPenColor(stdDraw.BLACK);
        stdDraw.text(0.5, 0.85, "HAPPY MOTHER'S DAY");
        Font font = new Font("Jokerman", Font.BOLD, 36);
        stdDraw.setFont(font);
        stdDraw.setPenColor(stdDraw.MAGENTA);
        stdDraw.text(0.5, 0.85, "HAPPY MOTHER'S DAY");
